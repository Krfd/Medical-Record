...
if($run) {
    ...
    $stat = $row['status'];
        ...
        if(isset($_POST['update'])) {
            ...
            $update = ("UPDATE records SET lastname = '$lastname', firstname = '$firstname', sex = '$sex', age = '$age', con = '$con', status = '$stat' WHERE id = $id");
...
<body>
    ...
    <form method="post" class="form">
        <fieldset>
            ...
            <div class="row">
                <div class="col">
                    <button type="button" class="btn btn-outline-primary w-100" onclick="window.location.href = 'records.php'">Cancel</button>
                </div>
                <div class="col">
                    <button type="submit" name="update" class="btn btn-dark submit w-100">Submit</button>
                </div>
            </div>
        </fieldset>
    </form>
