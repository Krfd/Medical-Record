                    ...
                    <div class="container main w-100">
                        <div class="container">
                            <div class="col patients">
                                <h2 class="table-title">User Requests</h2>
                                <br>
                                <table
                                ...
                                <tbody>
                                        ...
                                        if($result) {
                                            while($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td>$con</td>";
                                                echo "<td>$status</td>";
                                                echo '<td><button type="button" class="btn btn-danger"><a href="pending_delete.php?deleteid='.$id.'" style="color:white;"><i class="fa-solid fa-trash"></i></a></button></td>';
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
